...
const request = indexedDB.open(dbName, 4); // Updated version for new store
...
request.onupgradeneeded = (event) => {
    ...
    if (!db.objectStoreNames.contains(userStoreName)) {
        ...
        // Seed initial users (replacing previous mock users object)
        userStore.add({
        ...
        userStore.add({
            email: 'imtiazahammed575@gmail.com',
            password: 'pass2',
            name: 'User Two',
            mobile: '0987654321',
            dob: '1985-05-05',
